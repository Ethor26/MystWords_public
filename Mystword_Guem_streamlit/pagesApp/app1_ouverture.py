...
def app():
    ...
    st.title("OUVERTURE DU LOGICIEL MYSTWORD")
    st.write('Ouverture')
    ...
    Container_Apropos = st.container()
    Container_Apropos.write("En savoir plus:\n")
    Container_Apropos.code("file:///C:/Users/ethan/OneDrive%20-%20Efrei/L2-S2/L2S2-INFORMATIQUE/Programmation%20web/L2S2_ProgWeb_TP/Projet/Accueil.html")
